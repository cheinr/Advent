CREATE TABLE user (id INT NOT NULL IDENTITY(1,1), display_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL,
                   description TEXT NOT NULL, picture_url VARCHAR(255), user_group_id BIGINT, event_response_id BIGINT);
INSERT INTO user (id, display_name, email, description, picture_url, user_group_id, event_response_id) VALUES
  (1000, 'displayName1', 'email@address.com',
   ...
   'http://xacatolicos.com/app/images/avatar/icon-user.png', 2, 2),
